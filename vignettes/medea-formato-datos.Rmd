---
title: "Prepararación de las bases de datos para el Proyecto MEDEA3"
author: ""
...
## No disponible por el momento. Pendiente de la definición del seccionado unificado.
```
...
cambios_seccion <- elimina_cambios(
  cambios_seccion,
  c("3302405013", "3302407034", "3302403024", "3302403019",
    "3302403021", "3302403022", "3302403024", "3302406020"),
  c("3302405022", "3302403019", "3302403019",
    rep("3302403010", 4), "3302406010")
  )
gijon           <- une_secciones(
  cambios         = cambios_seccion[substr(sc_ref, 1, 5) == codigo & codigo_postal == FALSE, ],
  cartografia     = cartografia[cartografia$CUMUN == codigo, ],
  ...
  umbral_vivienda = 5,
  modo            = "manual",
  sc1             = paste0(codigo, c("03013", "01020", "06013", "05016", "06016",
                                     "08015", "09003", "04004", "07005")),
  sc2             = paste0(codigo, c("03012", "01021", "06014", "05022", "06019",
                                     "08021", "09015", "04010", "07047"))
)
...
oviedo <- une_secciones(
  ...
  umbral_vivienda = 5,
  modo            = "manual",
  sc1             = paste0(codigo, c("07003", "09015")),
  sc2             = paste0(codigo, c("07002", "09017"))
)
...
Solo se realizan uniones desde 2001 a 2011 para lograr la compatibilidad entre ambos censos. El resto de la información la disponen a nivel puntual. Esta circunstancia les obliga a adaptar la información de poblaciones al seccionado resultante de la llamada a `une_secciones` que se describe a continuación.
