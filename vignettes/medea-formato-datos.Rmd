...
* Objeto `censo`: `data.frame` con tres columnas (sección censal, índice para el año 2001 e índice para el año 2011) y tantas filas como secciones censales haya. Por ahora no es necesario que os preocupéis de esta parte de la información requerida: más adelante os daremos información más detallada sobre este objeto.
