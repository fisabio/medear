...
* Importación de los paquetes, datos y adaptación de su formato para la geocodificación.
...
# Importación de las paquetes, datos y adaptación de su formato para la geocodificación

## Carga de los paquetes necesarios para el proceso de geocodificación:
...
Si así se desea, es posible consultar este protocolo desde la ayuda del paquete (útil si estás utilizando una interfaz tipo [RStudio](https://www.rstudio.com/)), pues está incorporado dentro del mismo como una viñeta, siendo accesible con la sentencia `vignette("medear-protocolo")`.
