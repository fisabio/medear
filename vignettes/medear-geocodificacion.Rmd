---
title: "Protocolo de geocodificación"
author: "Grupo MEDEA"
date: "`r Sys.Date()`"
output: 
...
Una vez que te hayas asegurado que tu `data.frame` tenga la información que acabamos de comentar y con ese formato exactamente, las siguientes sentencias completan dicho `data.frame`, creando nuevas columnas que serán utilizadas más adelante:
