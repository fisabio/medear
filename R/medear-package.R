...
#'   \code{\link{une_secciones}}). En todo caso, se ofrece la fecha de
#'   la última actualización de los datos (siempre que esté disponible) como un
...
#'
#'   \describe{
#'     \item{\code{\link{descarga_cartografia}}}{Descarga de la cartografía
#'     nacional por sección censal para el año 2011 en formato SHP.}
#'     \item{\code{\link{descarga_poblaciones}}}{Descarga de la poblaciones
#'     por sección censal, sexo y grupos de edad (disponibilidad desde 2006
#'     hasta 2017).}
#'     \item{\code{\link{descarga_trameros}}}{Descarga de los trameros para
#'     las provincias indicadas en los años marcados (disponible desde 2004
#'     hasta 2017).}
#'     \item{\code{\link{detecta_cambios}}}{Identifica los cambios de
#'     sección censal entre distintos años.}
#'     \item{\code{\link{une_secciones}}}{Habiendo obtenido los cambios
#'     en el seccionado, se realiza la unión de las secciones en la
#'     cartografía y en las cifras de población.}
#'   }
#'
#'   Mantenedor: Carlos Vergara-Hernández \email{vergara_car@@gva.es}
#'
#'   Fuente: Elaboración propia con datos extraídos del sitio web del INE (\url{www.ine.es}).
#'
#'   Licencia: Los datos contenidos en este paquete han sido extraidos desde el sitio web del INE
#'   (\url{www.ine.es}) y modificados de acuerdo a las necesidades del
#'   proyecto, quedando sujeto su uso a la licencia INE
...
#'   \code{\link{detecta_cambios}},
#'   \code{\link{une_secciones}}
#'
#' @references
#'   \url{www.ine.es/}
