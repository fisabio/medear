...
#'
#' @param cod_provincia Cadena de car�cteres de longitud >= 1 con el c�digo de
...
#' @param ruta Cadena de car�cteres indicando la ruta en la que se almacenan los
...
#'   la secci�n censal.
#'
#' @param ... Par�metros adicionales en la lectura de datos (no es necesario su
#'   uso).
#'
...
#'
#' @description Descarga la cartograf�a del seccionado censal ofrecida
#'   p�blicamente por el INE para el a�o 2011.
#'
...
#'   10 car�cteres con el c�digo de secci�n censal (incluye provincia, municipio
#'   y distrito).} \item{CUMUN}{Cadena de 5 car�cteres con el c�digo del
#'   municipio (incluye provincia).} \item{CCA}{Cadena de 2 car�cteres con el
...
#'   dos d�gitos identifican la provincia, los siguientes tres d�gitos el
#'   municipio, los pr�ximos dos d�gitos el distrito y los �ltimos tres a la
#'   secci�n censal.
#'
...
#'   se debe utilizar la funci�n \code{\link{carga_datos}}.
#'
...
#'   \item{seccion}{C�digo de la secci�n censal.}
#'   \item{sexo}{Codificado como 0 para hombres y 1 para mujeres.}
#'   \item{year}{A�o al que se hace referencia.} El resto de columnas representan los distintos
#'   grupos de edad.
#'
#' @examples
#'
